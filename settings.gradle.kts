...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        create("libs") {
            library("bukkit", "io.sapphiremc.sapphire:sapphire-api:1.19-R0.1-SNAPSHOT")
            library("placeholderapi", "me.clip:placeholderapi:2.11.1")
            ...
            library("worldedit", "com.sk89q.worldedit:worldedit-bukkit:7.2.11-beta-01")
